...
int main(int argc, char* argv[]) {
  ...
  const AL::ALValue jointNames = AL::ALValue::array("HeadYaw", "HeadPitch");
  ...
  try {
    ...
    */
    ...
    AL::ALValue yawAngles = AL::ALValue::array(-1.5f, 1.5f, 0.0f);
    AL::ALValue pitchAngles = AL::ALValue::array(1.5f, 0.0f, 1.5f);
    AL::ALValue targetAngles = AL::ALValue::array(yawAngles,pitchAngles);

    /** Set the corresponding time lists, in seconds. */
    AL::ALValue yawTimes = AL::ALValue::array(3.0f, 6.0f, 9.0f);
    AL::ALValue pitchTimes = AL::ALValue::array(3.0f, 6.0f, 9.0f);
    ...
    */
    motion.angleInterpolation(jointNames, yawAngles, yawTimes, isAbsolute);
