...
#        resolution = vision_definitions.kQQVGA # 160  * 120 px
#        resolution = vision_definitions.k4VGA # 1280 * 960 px
        resolution = vision_definitions.kVGA # 640  * 480 px
...
if __name__ == '__main__':
    ...
    myWindow.show()
    osvrWindow = ImageWidget(IP, PORT, CameraID)
    osvrWindow.show()
